...
// KREATE's Window on iOS does not create a UIWindow — UIApplicationMain owns
...
std::unique_ptr<Window> Window::create(const WindowDesc &desc) {
    ...
    if (!uiWindow) {
        ...
        // before calling Kreate::CreateApp(). If we get here, the embedder
