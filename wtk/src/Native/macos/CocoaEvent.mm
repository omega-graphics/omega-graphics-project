...
static KeyCode key_code_from_ns(unsigned short keyCode) {
    // Apple ANSI virtual key codes (kVK_* from Carbon HIToolbox/Events.h).
    // NSEvent.keyCode returns these; do NOT confuse them with USB HID usage
    // IDs (the prior table mixed the two — letters were kVK, but the special
    // keys used HID-ish values, so e.g. Backspace/Tab/Space/modifiers all
    // resolved wrong; Backspace 0x33 in particular mapped to LeftControl,
    // which broke text editing).
    switch (keyCode) {
        // Letters (kVK_ANSI_*).
        ...
        // Editing / whitespace.
        case 0x24: return KeyCode::Enter;      // kVK_Return
        case 0x4C: return KeyCode::Enter;      // kVK_ANSI_KeypadEnter
        case 0x30: return KeyCode::Tab;        // kVK_Tab
        case 0x31: return KeyCode::Space;      // kVK_Space
        case 0x33: return KeyCode::Backspace;  // kVK_Delete (backward delete)
        case 0x75: return KeyCode::Delete;     // kVK_ForwardDelete
        case 0x35: return KeyCode::Escape;     // kVK_Escape
        // Modifiers.
        case 0x37: return KeyCode::LeftMeta;      // kVK_Command
        case 0x36: return KeyCode::RightMeta;     // kVK_RightCommand
        case 0x38: return KeyCode::LeftShift;     // kVK_Shift
        case 0x3C: return KeyCode::RightShift;    // kVK_RightShift
        case 0x3A: return KeyCode::LeftAlt;       // kVK_Option
        case 0x3D: return KeyCode::RightAlt;      // kVK_RightOption
        case 0x3B: return KeyCode::LeftControl;   // kVK_Control
        case 0x3E: return KeyCode::RightControl;  // kVK_RightControl
        case 0x39: return KeyCode::CapsLock;      // kVK_CapsLock
        // Navigation.
