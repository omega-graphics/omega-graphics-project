...
namespace OmegaWTK::Composition {
    ...
    class IDXBDCompositionRenderTarget : public _Parent {
        ...
        virtual void frameRect(Composition::Rect &rect, Core::SharedPtr<Brush> &brush, unsigned int width) = 0;
        virtual void fillRect(Composition::Rect &rect, Core::SharedPtr<Brush> &brush) = 0;
        virtual void frameRoundedRect(Composition::RoundedRect &rect, Core::SharedPtr<Brush> &brush, unsigned int width) = 0;
        virtual void fillRoundedRect(Composition::RoundedRect &rect, Core::SharedPtr<Brush> &brush) = 0;
        virtual Core::SharedPtr<BDCompositionImage> createImageFromBitmapImage(Core::SharedPtr<Media::BitmapImage> &img,Composition::Rect &newSize,unsigned v_id) = 0;
        virtual void drawImage(Core::SharedPtr<BDCompositionImage> &img,Composition::Point2D pos) = 0;
    ...
    public:
        bool needsSwapChain(){
         ...
         void frameRect(Composition::Rect &rect, Core::SharedPtr<Brush> &brush, unsigned int width);
         void frameRoundedRect(Composition::RoundedRect &rect, Core::SharedPtr<Brush> &brush, unsigned int width);
         ...
         Core::SharedPtr<BDCompositionImage> createImageFromBitmapImage(Core::SharedPtr<Media::BitmapImage> &img, Composition::Rect &newSize, unsigned int v_id);
    ...
    public:
         void redoDeviceContext();
          void redoSwapChain();
          void redoSwapChainWithNewSize(Composition::Rect & newRect);
          void resizeBuffers(Composition::Rect & newRect);
         void frameRect(Composition::Rect &rect, Core::SharedPtr<Brush> &brush, unsigned int width);
         void frameRoundedRect(Composition::RoundedRect &rect, Core::SharedPtr<Brush> &brush, unsigned int width);
         void fillRect(Composition::Rect &rect, Core::SharedPtr<Brush> &brush);
         ...
         void drawImage(Core::SharedPtr<BDCompositionImage> &img, Composition::Point2D pos);
        void drawText(Core::SharedPtr<TextRect> &textRect, Core::SharedPtr<Brush> &brush);
        DXBDCompositionImageRenderTarget(DXBDCompositionDevice * device,Composition::Rect & rect);
        static Core::SharedPtr<BDCompositionImageRenderTarget> Create(DXBDCompositionDevice *device,Composition::Rect & rect);
