...
function(OmegaWTKApp)
    ...
    elseif(TARGET_WIN32)
        ...
        set(EMBED ${OMEGAWTK_SOURCE_DIR}/target/windows/app.exe.manifest)
        configure_file(${OMEGAWTK_SOURCE_DIR}/target/windows/manifest.rc.in ${CMAKE_CURRENT_BINARY_DIR}/res.rc)
        target_sources(${_ARG_NAME} PRIVATE ${OMEGAWTK_SOURCE_DIR}/target/windows/mmain.cpp ${CMAKE_CURRENT_BINARY_DIR}/res.rc)
