...
// AQSpace::Impl and the two space-owned record types (AQManifoldCacheEntry,
// AQJointRecord) live in this private header so AQSpaceParticles.cpp (Phase 6)
// shares the same Impl layout. Moved verbatim from here — no behavior change.
